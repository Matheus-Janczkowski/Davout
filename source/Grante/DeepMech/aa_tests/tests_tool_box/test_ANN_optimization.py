...
class TestANNTools(unittest.TestCase):
    ...
    def test_quadratic_loss(self):
        ...
        loss = loss_assemblers.QuadraticLossOverLinearResidualAssemblerWithCustomGrad(
        ...
        loss_block = loss_assemblers.QuadraticLossOverLinearResidualAssemblerWithCustomGrad(
    ...
    def test_quadratic_generic_loss(self):

        print("\n#####################################################"+
        "###################\n#          Tests quadratic loss function"+
        " with generic residual         #\n###########################"+
        "#############################################\n")
        ...
        loss = loss_assemblers.QuadraticLossOverAnyResidualAssembler(
        A_list, b_list, block_multiplication=False)
        ...
        loss_block = loss_assemblers.QuadraticLossOverAnyResidualAssembler(
        A_list, b_list, block_multiplication=True)
    ...
    def test_quadratic_loss_fixed_block_multiplication(self):

        print("\n#####################################################"+
        "###################\n# Tests quadratic loss function with fix"+
        "ed block multiplication and no #\n#                          "+
        " custom gradient                            #\n##############"+
        "##########################################################\n")
