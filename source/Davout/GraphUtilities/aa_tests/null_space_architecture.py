...
create_box_collage("null_space_architecture.png", input_path=
get_parent_path_of_file(),

boxes_list=[{"contour color": "black", "fill color": "grey 2", "contour"+
" thickness": 0.2, "position": [53.0, 99.0], "width": 105.0, "height": 70.0,
"contour style": "solid", "origin point": "bottom-left"},
{"contour color": "black", "fill color": "grey 1", "contour"+
" thickness": 0.2, "position": [54, 100.0], "width": 103.0, "height": 33.5,
"contour style": "solid", "origin point": "bottom-left"},
{"contour color": "black", "fill color": "grey 1", "contour"+
" thickness": 0.2, "position": [54.0, 134.5], "width": 103.0, "height": 33.5,
"contour style": "solid", "origin point": "bottom-left"}], 
...
verbose=True, no_padding=True, add_overlaying_grid=True, dpi=600,
